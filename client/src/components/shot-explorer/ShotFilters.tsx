  ...
  return (
    <div className="flex flex-wrap items-end gap-4">
      <div className="space-y-1.5">
        ...
        >
          <SelectTrigger id="period-filter" className="w-35">
      ...
      <div className="space-y-1.5">
        ...
        >
          <SelectTrigger id="shot-type-filter" className="w-38">
      ...
      <div className="space-y-1.5">
        ...
        >
          <SelectTrigger id="danger-filter" className="w-45">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {DANGER_LEVELS.map((d) => (
      ...
      <div className="space-y-1.5">
        ...
        >
          <SelectTrigger id="limit-filter" className="w-32">
            <SelectValue />
          </SelectTrigger>
          <SelectContent>
            {LIMITS.map((l) => (
      ...
      {players.length > 0 && (
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onPlayerIdChange(value === "all" ? undefined : parseInt(value))
            }
          >
            <SelectTrigger id="player-filter" className="w-45">
