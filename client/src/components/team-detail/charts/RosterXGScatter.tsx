        ...
        <img
          ...
          style={{
            ...
            border: isSelected
              ...
              : `2px solid ${isOverperforming ? "hsl(142, 76%, 36%)" : "hsl(0, 72%, 51%)"}`,
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <p className="font-semibold truncate">
              ...
              <span
                className={`ml-2 text-xs ${isOverperforming ? "text-success" : "text-destructive"}`}
              >
                {isOverperforming ? "Hot" : "Cold"}
              </span>
            </p>
            <div className="flex items-center gap-3 text-sm text-muted-foreground">
              ...
              <span
                className={`font-mono font-semibold ${isOverperforming ? "text-success" : "text-destructive"}`}
              >
                {isOverperforming ? "+" : ""}
                {data.diff.toFixed(1)}
              </span>
